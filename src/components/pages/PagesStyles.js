...
const useStyles = makeStyles((theme) => ({
  ...
  tableStatus: {
    ...
    "&.error-status": {
      border: (props) =>
        props.errorColor ? `0.2rem solid ${props.errorColor}` : "none",
      color: (props) => (props.errorColor ? props.errorColor : "none"),
      backgroundColor: (props) =>
        props.errorBg ? props.errorBg : "transparent",
    },
    "&.warning-status": {
      color: (props) => (props.warningColor ? props.warningColor : "none"),
      border: (props) =>
        props.warningColor ? `0.2rem solid ${props.warningColor}` : "none",
      backgroundColor: (props) =>
        props.warningBg ? props.warningBg : "transparent",
    },
    "&.success-status": {
      border: (props) =>
        props.successColor ? `0.2rem solid ${props.successColor}` : "none",
