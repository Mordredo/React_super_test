...
const NavbarMenu = () => {
  ...
  const manageList = menuContent.filter((elem, index) => elem.type === types.manageType);
  const featuresList = menuContent.filter((elem, index) => elem.type === types.featuresType);
